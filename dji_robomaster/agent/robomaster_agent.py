...
from dji_robomaster.agent.dialogue_objects import LocoBotCapabilities, LocoGetMemoryHandler, PutMemoryHandler, LocoInterpreter
import rotation
from robomaster_mover import RoboMasterMover
...
class RoboMasterAgent(LocoMCAgent):
    """Implements an instantiation of the LocoMCAgent on a DJI robomaster. It starts
    ...
    Example:
        >>> python robomaster_agent.py'
    """

    coordinate_transforms = rotation

    def __init__(self, opts, name="Locobot"):
        super(RoboMasterAgent, self).__init__(opts)
    ...
    def init_physical_interfaces(self):
        ...
        #assumes single dji on lan for now
        self.mover = RoboMasterMover()
