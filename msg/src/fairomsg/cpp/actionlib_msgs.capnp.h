...
public:
  ...
  inline ::capnp::List<::mrp::actionlib::GoalStatus,
...
public:
  ...
  getStatusList();
  inline void setStatusList(::capnp::List<::mrp::actionlib::GoalStatus,
                                          ::capnp::Kind::STRUCT>::Reader value);
  inline ::capnp::List<::mrp::actionlib::GoalStatus,
                       ::capnp::Kind::STRUCT>::Builder
  initStatusList(unsigned int size);
  inline void adoptStatusList(
      ::capnp::Orphan<::capnp::List<::mrp::actionlib::GoalStatus,
                                    ::capnp::Kind::STRUCT>> &&value);
  inline ::capnp::Orphan<
      ::capnp::List<::mrp::actionlib::GoalStatus, ::capnp::Kind::STRUCT>>
  disownStatusList();
...
inline void
GoalID::Builder::adoptStamp(::capnp::Orphan<::mrp::std::Time> &&value) {
...
inline void GoalID::Builder::adoptId(::capnp::Orphan<::capnp::Text> &&value) {
...
#endif // !CAPNP_LITE
inline void
GoalStatus::Builder::setGoalId(::mrp::actionlib::GoalID::Reader value) {
...
GoalStatus::Builder::disownGoalId() {
...
inline void
GoalStatus::Builder::adoptText(::capnp::Orphan<::capnp::Text> &&value) {
  ::capnp::_::PointerHelpers<::capnp::Text>::adopt(
      _builder.getPointerField(::capnp::bounded<1>() * ::capnp::POINTERS),
      kj::mv(value));
}
...
#endif // !CAPNP_LITE
inline void
GoalStatusArray::Builder::setHeader(::mrp::std::Header::Reader value) {
...
GoalStatusArray::Builder::disownHeader() {
...
inline ::capnp::List<::mrp::actionlib::GoalStatus,
                     ::capnp::Kind::STRUCT>::Reader
GoalStatusArray::Reader::getStatusList() const {
...
inline ::capnp::List<::mrp::actionlib::GoalStatus,
                     ::capnp::Kind::STRUCT>::Builder
GoalStatusArray::Builder::getStatusList() {
  return ::capnp::_::PointerHelpers<
      ::capnp::List<::mrp::actionlib::GoalStatus, ::capnp::Kind::STRUCT>>::
      get(_builder.getPointerField(::capnp::bounded<1>() * ::capnp::POINTERS));
}
inline void GoalStatusArray::Builder::setStatusList(
    ::capnp::List<::mrp::actionlib::GoalStatus, ::capnp::Kind::STRUCT>::Reader
        value) {
...
inline ::capnp::List<::mrp::actionlib::GoalStatus,
                     ::capnp::Kind::STRUCT>::Builder
GoalStatusArray::Builder::initStatusList(unsigned int size) {
  return ::capnp::_::PointerHelpers<
      ::capnp::List<::mrp::actionlib::GoalStatus, ::capnp::Kind::STRUCT>>::
...
inline ::capnp::Orphan<
    ::capnp::List<::mrp::actionlib::GoalStatus, ::capnp::Kind::STRUCT>>
GoalStatusArray::Builder::disownStatusList() {
  return ::capnp::_::PointerHelpers<
      ::capnp::List<::mrp::actionlib::GoalStatus, ::capnp::Kind::STRUCT>>::
      disown(
          _builder.getPointerField(::capnp::bounded<1>() * ::capnp::POINTERS));
