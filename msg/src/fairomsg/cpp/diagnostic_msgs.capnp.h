...
public:
  ...
  inline ::capnp::List<::mrp::diagnostic::DiagnosticStatus,
...
public:
  ...
  getStatus();
  inline void setStatus(::capnp::List<::mrp::diagnostic::DiagnosticStatus,
                                      ::capnp::Kind::STRUCT>::Reader value);
  inline ::capnp::List<::mrp::diagnostic::DiagnosticStatus,
                       ::capnp::Kind::STRUCT>::Builder
  initStatus(unsigned int size);
  inline void
  adoptStatus(::capnp::Orphan<::capnp::List<::mrp::diagnostic::DiagnosticStatus,
                                            ::capnp::Kind::STRUCT>> &&value);
  inline ::capnp::Orphan<
      ::capnp::List<::mrp::diagnostic::DiagnosticStatus, ::capnp::Kind::STRUCT>>
  disownStatus();
...
public:
  ...
  inline ::capnp::List<::mrp::diagnostic::KeyValue,
                       ::capnp::Kind::STRUCT>::Reader
  getValues() const;
...
public:
  ...
  inline ::capnp::List<::mrp::diagnostic::KeyValue,
                       ::capnp::Kind::STRUCT>::Builder
  getValues();
  inline void setValues(::capnp::List<::mrp::diagnostic::KeyValue,
                                      ::capnp::Kind::STRUCT>::Reader value);
  inline ::capnp::List<::mrp::diagnostic::KeyValue,
                       ::capnp::Kind::STRUCT>::Builder
  initValues(unsigned int size);
  inline void
  adoptValues(::capnp::Orphan<::capnp::List<::mrp::diagnostic::KeyValue,
                                            ::capnp::Kind::STRUCT>> &&value);
  inline ::capnp::Orphan<
      ::capnp::List<::mrp::diagnostic::KeyValue, ::capnp::Kind::STRUCT>>
  disownValues();
...
#endif // !CAPNP_LITE
inline void
DiagnosticArray::Builder::setHeader(::mrp::std::Header::Reader value) {
...
DiagnosticArray::Builder::disownHeader() {
...
inline ::capnp::List<::mrp::diagnostic::DiagnosticStatus,
                     ::capnp::Kind::STRUCT>::Reader
DiagnosticArray::Reader::getStatus() const {
  return ::capnp::_::PointerHelpers<::capnp::List<
      ::mrp::diagnostic::DiagnosticStatus, ::capnp::Kind::STRUCT>>::
      get(_reader.getPointerField(::capnp::bounded<1>() * ::capnp::POINTERS));
}
inline ::capnp::List<::mrp::diagnostic::DiagnosticStatus,
                     ::capnp::Kind::STRUCT>::Builder
DiagnosticArray::Builder::getStatus() {
  return ::capnp::_::PointerHelpers<::capnp::List<
      ::mrp::diagnostic::DiagnosticStatus, ::capnp::Kind::STRUCT>>::
      get(_builder.getPointerField(::capnp::bounded<1>() * ::capnp::POINTERS));
}
inline void DiagnosticArray::Builder::setStatus(
    ::capnp::List<::mrp::diagnostic::DiagnosticStatus,
                  ::capnp::Kind::STRUCT>::Reader value) {
  ::capnp::_::PointerHelpers<::capnp::List<::mrp::diagnostic::DiagnosticStatus,
                                           ::capnp::Kind::STRUCT>>::
...
inline ::capnp::List<::mrp::diagnostic::DiagnosticStatus,
                     ::capnp::Kind::STRUCT>::Builder
DiagnosticArray::Builder::initStatus(unsigned int size) {
  return ::capnp::_::PointerHelpers<::capnp::List<
      ::mrp::diagnostic::DiagnosticStatus, ::capnp::Kind::STRUCT>>::
...
inline void DiagnosticArray::Builder::adoptStatus(
    ::capnp::Orphan<::capnp::List<::mrp::diagnostic::DiagnosticStatus,
                                  ::capnp::Kind::STRUCT>> &&value) {
  ::capnp::_::PointerHelpers<::capnp::List<::mrp::diagnostic::DiagnosticStatus,
                                           ::capnp::Kind::STRUCT>>::
...
inline ::capnp::Orphan<
    ::capnp::List<::mrp::diagnostic::DiagnosticStatus, ::capnp::Kind::STRUCT>>
DiagnosticArray::Builder::disownStatus() {
  return ::capnp::_::PointerHelpers<::capnp::List<
      ::mrp::diagnostic::DiagnosticStatus, ::capnp::Kind::STRUCT>>::
      disown(
...
DiagnosticStatus::Builder::initName(unsigned int size) {
  return ::capnp::_::PointerHelpers<::capnp::Text>::init(
      _builder.getPointerField(::capnp::bounded<0>() * ::capnp::POINTERS),
      size);
}
inline void
DiagnosticStatus::Builder::adoptName(::capnp::Orphan<::capnp::Text> &&value) {
...
inline ::capnp::Text::Builder
DiagnosticStatus::Builder::initMessage(unsigned int size) {
  return ::capnp::_::PointerHelpers<::capnp::Text>::init(
      _builder.getPointerField(::capnp::bounded<1>() * ::capnp::POINTERS),
      size);
}
...
DiagnosticStatus::Builder::disownMessage() {
  return ::capnp::_::PointerHelpers<::capnp::Text>::disown(
      _builder.getPointerField(::capnp::bounded<1>() * ::capnp::POINTERS));
}
...
inline void
DiagnosticStatus::Builder::setHardwareId(::capnp::Text::Reader value) {
  ::capnp::_::PointerHelpers<::capnp::Text>::set(
      _builder.getPointerField(::capnp::bounded<2>() * ::capnp::POINTERS),
      value);
}
inline ::capnp::Text::Builder
DiagnosticStatus::Builder::initHardwareId(unsigned int size) {
  return ::capnp::_::PointerHelpers<::capnp::Text>::init(
      _builder.getPointerField(::capnp::bounded<2>() * ::capnp::POINTERS),
      size);
}
...
inline ::capnp::Orphan<::capnp::Text>
DiagnosticStatus::Builder::disownHardwareId() {
  return ::capnp::_::PointerHelpers<::capnp::Text>::disown(
      _builder.getPointerField(::capnp::bounded<2>() * ::capnp::POINTERS));
}
...
inline ::capnp::List<::mrp::diagnostic::KeyValue, ::capnp::Kind::STRUCT>::Reader
DiagnosticStatus::Reader::getValues() const {
...
inline ::capnp::List<::mrp::diagnostic::KeyValue,
                     ::capnp::Kind::STRUCT>::Builder
DiagnosticStatus::Builder::getValues() {
  return ::capnp::_::PointerHelpers<
      ::capnp::List<::mrp::diagnostic::KeyValue, ::capnp::Kind::STRUCT>>::
      get(_builder.getPointerField(::capnp::bounded<3>() * ::capnp::POINTERS));
}
inline void DiagnosticStatus::Builder::setValues(
    ::capnp::List<::mrp::diagnostic::KeyValue, ::capnp::Kind::STRUCT>::Reader
        value) {
...
inline ::capnp::List<::mrp::diagnostic::KeyValue,
                     ::capnp::Kind::STRUCT>::Builder
DiagnosticStatus::Builder::initValues(unsigned int size) {
  return ::capnp::_::PointerHelpers<
      ::capnp::List<::mrp::diagnostic::KeyValue, ::capnp::Kind::STRUCT>>::
...
inline void DiagnosticStatus::Builder::adoptValues(
    ::capnp::Orphan<::capnp::List<::mrp::diagnostic::KeyValue,
                                  ::capnp::Kind::STRUCT>> &&value) {
  ::capnp::_::PointerHelpers<
      ::capnp::List<::mrp::diagnostic::KeyValue, ::capnp::Kind::STRUCT>>::
...
inline ::capnp::Orphan<
    ::capnp::List<::mrp::diagnostic::KeyValue, ::capnp::Kind::STRUCT>>
DiagnosticStatus::Builder::disownValues() {
  return ::capnp::_::PointerHelpers<
      ::capnp::List<::mrp::diagnostic::KeyValue, ::capnp::Kind::STRUCT>>::
      disown(
...
inline void
KeyValue::Builder::adoptKey(::capnp::Orphan<::capnp::Text> &&value) {
  ::capnp::_::PointerHelpers<::capnp::Text>::adopt(
      _builder.getPointerField(::capnp::bounded<0>() * ::capnp::POINTERS),
      kj::mv(value));
}
...
inline void
KeyValue::Builder::adoptValue(::capnp::Orphan<::capnp::Text> &&value) {
  ::capnp::_::PointerHelpers<::capnp::Text>::adopt(
      _builder.getPointerField(::capnp::bounded<1>() * ::capnp::POINTERS),
      kj::mv(value));
}
