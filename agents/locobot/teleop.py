...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ip", help="Server device (robot) IP. Default is 0.0.0.0", type=str, default="0.0.0.0"
    )
    parser.add_argument(
        "--backend",
    ...
    while True:
        ...
        sio.emit(
            "map", {"x": x, "y": y, "yaw": yaw, "map": mover.get_obstacles_in_canonical_coords()}
        )
