    ...
    for command in commands:
        ...
        # Commands we introduce
            ...
            scout = EndToEndSemanticScout(
                ...
                policy="robot_camera_settings_without_noise_and_coco_detector_il",
                # policy="original_camera_settings_and_mp3d_detector_rl",
                # policy="robot_camera_settings_and_coco_detector_rl",
            )
