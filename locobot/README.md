...
python locobot_agent.py
    ...
    <tr valign="top">
        <td colspan=3> 4. Open the dashboard to interact with the assistant on `localhost:8000`. (Please note that the dashboard is currently supported only on Google Chrome.)
        </td>      
    </tr>    
  </table>
</p>
