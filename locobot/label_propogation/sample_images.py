...
root_dir = "/checkpoint/dhirajgandhi/active_vision/habitat_data_with_seg/rgb"
...
img_list_file = open(
    "/checkpoint/dhirajgandhi/active_vision/habitat_data_with_seg/sampled_imgs.txt", "w"
)
...
for i, img_path in enumerate(list_imgs):
    if i % skip == 0:
        print(img_path)
        img_list_file.write(img_path.split("/")[-1] + "\n")
