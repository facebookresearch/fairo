...
# ./launch_training.sh /checkpoint/apratik/jobs/reexplore/train_data_1805/train_data_1805 instance
# ./launch_training.sh /checkpoint/apratik/jobs/reexplore/train_data_1805_3sample/train_data_1805_3sample instance 
