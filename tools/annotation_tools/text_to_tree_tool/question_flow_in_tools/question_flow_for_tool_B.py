...
LOCATION_REL_OBJECT = [
    {
        "text": "Somewhere relative to (or exactly at) another object(s), area(s) or person",
...
def get_questions(child, action, optional_words=None):
    ...
    if child == "schematic":
    ...
    elif child in ["location", "receiver_location"]:
        ...
        if action in ["build", "copy", "spawn", "dig"]:
            ...
            question_1 = "Where should the assistant perform the movement"
        elif action == "get":
            question_1 = "Where should the assistant bring the object to"
        ...
        QUESTION = [
            ...
            {
                "text": "If a measure of distance is specified for steps, which unit ?",
                "key": "location.has_measure",
                "span": True,
                "optional": True,
                "tooltip": "e.g. in 'go left 5 meters' select 'meters'",
            },
        ]
        return QUESTION
    elif child == "facing":
        QUESTION = [
            {
                "text": "Click on options below to determine how or where the bot should "
                + optional_words,
                "key": "facing",
                "add_radio_other": False,
                "tooltip": "e.g. in 'turn all t'",
                "radio": [
                    {
                        "text": "Relative to the bot in horizontal plane",
                        "key": "rel_yaw",
                        "tooltip": "'left', 'right', 'front', 'back', 'around' etc",
                        "next": [
                            {
                                "text": "Select the value",
                                "key": "relative_yaw.angle",
                                "add_radio_other": False,
                                "radio": [
                                    {"text": "Left or west", "key": "-90"},
                                    {"text": "Right or east", "key": "90"},
                                    {"text": "Front or north", "key": "0"},
                                    {"text": "Back or south in clockwise direction", "key": "180"},
                                    {
                                        "text": "Back or south in anti-clockwise direction",
                                        "key": "-180",
                                    },
                                    {"text": "Front-left / northwest", "key": "-45"},
                                    {"text": "Front-right / northeast", "key": "45"},
                                    {"text": "Back-left / southwest", "key": "-135"},
                                    {"text": "Front-right / southeast", "key": "135"},
                                    {"text": "All the way around clockwise", "key": "360"},
                                    {"text": "All the way around anticlockwise", "key": "-360"},
                                    {
                                        "text": "None of the categories above, select words in sentence instead",
                                        "key": "check",
                                        "next": [
                                            {
                                                "text": "Select words in sentence that represent the measure",
                                                "span": True,
                                                "optional": True,
                                                "key": "yaw_span",
                                                "tooltip": "e.g. in 'turn left 20 degrees' select 'left 20 degrees'",
                                            }
                                        ],
                                    },
                                ],
                    ...
                    {
                        "text": "Relative to the bot in vertical plane",
                        "key": "rel_pitch",
                        "tooltip": "'up', 'down' etc",
                        "next": [
                            {
                                "text": "Select the value",
                                "key": "relative_pitch.angle",
                                "add_radio_other": False,
                                "radio": [
                                    {"text": "Up", "key": "90"},
                                    {"text": "Down", "key": "-90"},
                                    {"text": "Tilted upwards", "key": "-45"},
                                    {"text": "Tilted downwards", "key": "45"},
                                    {
                                        "text": "None of the categories above, select words instead",
                                        "key": "check",
                                        "next": [
                                            {
                                                "text": "Select words in sentence that represent the measure",
                                                ...
                                                "optional": True,
                                                "key": "pitch_span",
                                                "tooltip": "e.g. in 'turn up 20 degrees' select 'up 20 degrees'",
                                            }
                                        ],
                                    },
                                ],
                    ...
                    {
                        "text": "Absolute measure in degrees on horizontal plane",
                        "tooltip": "e.g. 'turn 20 degrees' , 'look at ( 20 , 30 )'",
                        "key": "yaw_check",
                        "next": [
                            {
                                "text": "Select words in sentence that represent the measure",
                                ...
                                "optional": True,
                                "key": "yaw",
                                "tooltip": "e.g. in 'look at ( 20 , 30 )' select '20'",
                            }
                        ],
                    },
                    {
                        "text": "Absolute measure in degrees on vertical plane",
                        "tooltip": "e.g. 'look up 20 degrees' , 'look at ( 20 , 30 )'",
                        "key": "pitch_check",
                        "next": [
                            {
                                "text": "Select words in sentence that represent the measure",
                                ...
                                "optional": True,
                                "key": "pitch",
                                "tooltip": "e.g. in 'look at ( 20 , 30 )' select '30'",
                            }
                        ],
                    },
                    {
                        "text": "Some other location",
                        "tooltip": "e.g. 'turn towards the sheep' , 'look at me'",
                        "key": "location_check",
                        "next": [
                            {
                                "text": "Give details about the location",
                                "key": "location",
                                "tooltip": "e.g. 'look at the sheep', 'look here'",
