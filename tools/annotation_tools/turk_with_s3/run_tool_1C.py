...
rc = subprocess.call(
    ["python3 create_jobs.py --xml_file fetch_question_C.xml --tool_num 3 --input_csv C/turk_input.csv --job_spec_csv C/turk_job_specs.csv"], shell=True
)
if rc != 0:
...
rc = subprocess.call(["python3 get_results.py --output_csv C/turk_output.csv"], shell=True)
if rc != 0:
...
rc = subprocess.call(["python collate_answers.py --turk_output_csv C/turk_output.csv --job_spec_csv C/turk_job_specs.csv --collate_output_csv C/processed_outputs.csv"], shell=True)
if rc != 0:
