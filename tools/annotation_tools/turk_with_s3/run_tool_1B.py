...
rc = subprocess.call(
    ["python3 create_jobs.py --xml_file fetch_question_B.xml --tool_num 2 --input_csv B/turk_input.csv --job_spec_csv B/turk_job_specs.csv"], shell=True
)
if rc != 0:
...
rc = subprocess.call(["python3 get_results.py --output_csv B/turk_output.csv"], shell=True)
if rc != 0:
