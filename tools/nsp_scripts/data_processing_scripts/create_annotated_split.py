...
if __name__ == "__main__":
    ...
    parser.add_argument("--raw_data_path", type=str, default="craftassist/agent/datasets/full_data/")
    parser.add_argument("--output_path", type=str, default="craftassist/agent/datasets/annotated_data/")
    parser.add_argument("--filename", type=str, default="annotated.txt")
    parser.add_argument("--split_ratio", type=str, default="0.7:0.2:0.1", help="train:valid:test split of dataset")
