...
model_args_path = "../../craftassist/agent/models/semantic_parser/ttad_bert_updated/caip_test_model_args.pk"
...
model_args.tree_voc_file = "craftassist/agent/models/semantic_parser/ttad_bert_updated/caip_test_model_tree.json"
