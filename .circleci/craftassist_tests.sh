...
pytest --cov-report=xml:$SHARED_PATH/test_full_craftassist_agent.xml --cov=droidlet --cov=agents/craftassist  agents/craftassist/tests/ --disable-pytest-warnings
