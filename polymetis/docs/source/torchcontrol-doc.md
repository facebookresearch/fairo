...
When starting to write your own policies, a good place to start is to go through the [built-in policies](https://github.com/facebookresearch/droidlet/tree/main/polymetis/polymetis/python/torchcontrol/policies) as examples.
