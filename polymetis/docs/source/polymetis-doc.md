...
See instructions in [examples](https://github.com/facebookresearch/droidlet/tree/main/polymetis/examples) to run the server and client. Clients include:
...
[Hydra](http://hydra.cc/) configuration files can be found in [polymetis/conf/robot_client](https://github.com/facebookresearch/droidlet/tree/main/polymetis/polymetis/conf/robot_client).
...
Definitions of available methods can be found [here](https://github.com/facebookresearch/droidlet/tree/main/polymetis/polymetis/python/polymetis/robot_interface.py).
Sample user scripts can be found in [examples](https://github.com/facebookresearch/droidlet/tree/main/polymetis/examples).
