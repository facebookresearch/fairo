...
from polymetis.python.polysim.envs import MujocoManipulatorEnv
...
def test_inverse_dynamics(pybullet_env, mj_manip_env, joint_states):
    ...
    mj_id = torch.Tensor(
        mj_manip_env.compute_inverse_dynamics(joint_pos, joint_vel, joint_acc)
    )
    print(
