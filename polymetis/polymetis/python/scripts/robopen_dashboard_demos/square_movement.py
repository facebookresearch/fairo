    ...
    for i in range(control_hz * time_left):
        ...
        ros_msg = geometry_msgs.TransformStamped(
            ...
            transform = geometry_msgs.Transform(
                translation = geometry_msgs.Vector3(x=ee_pos_list[0], y=ee_pos_list[1], z=ee_pos_list[2]),
                rotation = geometry_msgs.Quaternion(x=ee_quat_list[0], y=ee_quat_list[1], z=ee_quat_list[2], w=ee_quat_list[3])
            )
        )
        hdrs = [("content-type", 'application/x-capnp; schema="geometry_msgs/TransformStamped"')]
