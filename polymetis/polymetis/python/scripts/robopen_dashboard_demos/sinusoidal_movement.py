...
if __name__ == "__main__":
    ...
    for i in range(time_left * control_hz):
        ...
        # sinusoidal function
        joint_positions[target_joint] = np.sin(np.pi * i / (T * control_hz)) * joint_limit
        ...
        hdrs = [("content-type", 'application/x-capnp; schema="sensor_msgs/JointState"')]
        ...
        msg = {
            "position": {
                ...
                "actual_position": robot.get_robot_state().joint_positions[target_joint]
            }
        }
