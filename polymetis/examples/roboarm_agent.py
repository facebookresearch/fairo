...
from droidlet.perception.semantic_parsing.utils.interaction_logger import (
    InteractionLogger,
)
...
class RoboarmAgent(DroidletAgent):
    ...
    def shutdown(self):
        ...
        os._exit(
            0
        )  # TODO: remove and figure out why multiprocess sometimes hangs on exit
    ...
    def createRGB(self, im):
        ...
        pts = np.asarray(
            [
                xyz_canonical_coords_to_pyrobot_coords((x, y, 1))
