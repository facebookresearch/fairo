...
move_arm('armposes/pen_pre_spin.json', time_to_go=3.0, blocking=True, offset=[0., -0.1, -0.10])
#move_arm_joint('armposes/grasp_ready.json')
print('ready')


move_arm('armposes/pen_pre_spin.json', time_to_go=3.0, blocking=True, offset=[0., 0., -0.10])
