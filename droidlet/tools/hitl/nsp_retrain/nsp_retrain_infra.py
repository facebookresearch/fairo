...
if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--droidlet_dir", default="/private/home/yuxuans/Workspace/droidlet/", type=str, help="Absolute location of droidlet root")
    ...
    parser.add_argument("--sweep_runner_dir", default="/checkpoint/yuxuans/nsp_cl_scripts/", type=str, help="Absolute location of sweep_runner script")
    parser.add_argument("--sweep_config_folder", default="/checkpoint/yuxuans/nsp/sweeps/scripts/configs/auto_sweep_configs/", type=str, help="Absolute location of sweep configs")
    ...
    ndl = NSPNewDataListener(batch_id=20211002004351, opts=opts)
    runner = TaskRunner()
    runner.register_job_listeners([ndl])
    runner.run()