...
def timing_charts(run_ids: list) -> None:
    ...
    plot_hist(c_dict, target_val=5, xlabel="HIT Index", ylabel="Number of commands per HIT", ymax=20)
    ...
    plot_hist(score_dict, target_val=6.5, xlabel="HIT Index", ylabel='HIT Performance "Stoplight" Score')
