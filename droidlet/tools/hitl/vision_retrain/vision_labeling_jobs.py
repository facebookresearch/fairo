...
class VisionLabelingJob(DataGenerator):
    ...
    def run(self) -> None:
        ...
        try:
            #Generate scenes
            scene_save_path = os.path.join(os.getcwd(), "../../crowdsourcing/vision_annotation_task/server_files/extra_refs/scene_list.json")
            ...
            scene_gen_cmd = "python3 " + \
                ...
                " --save_data_path=" + scene_save_path + \
                " --iglu_scenes=" + os.environ['IGLU_SCENE_PATH']
            try:
            ...
            with open("../../crowdsourcing/vision_annotation_task/conf/labeling.yaml", "w") as stream:
            ...
            logging.info(f"Mephisto labeling job [{self._batch_id}] complete, retreiving results from local DB")
            ...
            with open(results_csv, "w") as f:
                ...
                for unit in units:
                    ...
                    with open(f"../../crowdsourcing/vision_annotation_task/server_files/extra_refs/{outputs['scene_filename']}", "r") as js:
            ...
            logging.info(f"Uploading job results to S3: {upload_key}")
            labeled_scene_list = f"{HITL_TMP_DIR}/{self._batch_id}/vision_labeling/labeled_scene_list.json"
