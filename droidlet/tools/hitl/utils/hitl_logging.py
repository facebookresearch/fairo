...
class HitlLogging():
    ...
    allows the caller class to registering for a logger name and logs into seperate files.
    ...
    """
    def __init__(self, batch_id: int, logger_name=None, formatter=DEFAULT_LOG_FORMATTER, level=logging.WARNING):
