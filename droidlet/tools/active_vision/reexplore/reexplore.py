...
from droidlet.tools.active_vision.common_utils import log_time
...
def launch_reexplore(
    data_dir: str, job_dir: str, noise: bool, num_traj: int, setting: str
) -> None:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_traj", type=int, default=2, help="number of trajectories to run reexploration for"
    )
    parser.add_argument("--setting", type=str, help="instance or class setting")
    parser.add_argument(
        "--slurm",
        action="store_true",
        default=False,
