...
def format_for_printing_data(data):
    ...
    try:
        ...
        pass
    try:
        output_string += f"Command List ID: {outputs['listID']}\n"
    except:
        pass
    try:
        output_string += f"Command #1 Result: {outputs['command_1']}\n"
    except:
        pass
    try:
    ...
    try:
        ...
        pass
    try:
        output_string += f"Command #3 Result: {outputs['command_3']}\n"
    except:
        pass
    try:
    ...
    try:
        ...
        pass
    try:
        output_string += f"Command #5 Result: {outputs['command_5']}\n"
    except:
        pass
    try:
        output_string += f"Command #5 Feedback: {outputs['command_5_feedback']}\n"
    except:
        pass
    try:
        output_string += f"Command #6 Result: {outputs['command_6']}\n"
    except:
        pass
    try:
        output_string += f"Command #6 Feedback: {outputs['command_6_feedback']}\n"
    except:
        pass
    try:
        output_string += f"Command #7 Result: {outputs['command_7']}\n"
    except:
        pass
    try:
        output_string += f"Command #7 Feedback: {outputs['command_7_feedback']}\n"
    except:
        pass
