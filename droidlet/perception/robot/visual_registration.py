...
def pointcloud_registration_global(src_pcd, dst_pcd):
    voxel_size = 0.05
...
def pointcloud_registration_local(src_pcd, dst_pcd, initial_transform):
    pass
...
class SLAM:    
    def __init__(self, intrinsic, depth_ref):
        ...
        self.model = o3d.t.pipelines.slam.Model(config.voxel_size, 16,
                                                config.block_count,
