...
from droidlet.base_util import diag_adjacent, to_block_pos, XYZ, IDM, pos_to_np, euclid_dist
...
class LowLevelMCPerception:
    ...
    def maybe_add_block_to_memory(self, xyz: XYZ, idm: IDM, boring_blocks: Tuple[int], agent_placed=False):
