...
DATA_DIR="shapes_4kind_6000_nfbid_0" 
DATA_PATH="$DATA_ROOT$DATA_DIR/"

# hyperparameters
NEPOCHS=500
NOTE="CLIP_4_KIND_TEST_DIST"
BATCH_SZ=256
        ...
        do
            ...
            do
                ...
                do
                    ...
                    do
                        JOB_NAME="data_${DATA_DIR}_nepochs_${NEPOCHS}_lr_${LR}_batchsz_${BATCH_SZ}_sampleEmptyProb_${SAMPLE_EMPTY_PROB}_hiddenDim_${HIDDEN_DIMS}_noTargetProb_${NO_TARGET_PROB}_probThreshold_${PROB_THRESHOLD}_queryEmbed_${QUERY_EMBED}_note_${NOTE}"
