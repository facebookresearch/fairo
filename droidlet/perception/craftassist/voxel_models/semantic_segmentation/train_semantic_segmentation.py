...
def main(args):
    ...
    pre_build_classes = build_class_map(args.data_dir)
    ...
    train_data = SemSegData(args.data_dir + "training_data.pkl", nexamples=args.debug, augment=aug, no_target_prob=args.no_target_prob, query_embed=args.query_embed, classes=pre_build_classes)
    # train_classes = train_data.get_classes()
    valid_data = SemSegData(args.data_dir + "validation_data.pkl", nexamples=args.debug, augment=aug, classes=pre_build_classes, no_target_prob=args.no_target_prob, query_embed=args.query_embed)
    ...
    vDL, sampler_valid = distributed.wrap_dataset(args, valid_data, None, sampler=None)
