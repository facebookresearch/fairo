...
class DVoxelEngine {
    ...
    updateAgents(agentsInfo) {
        ...
        agentsInfo.forEach(function(key, index) {
            ...
            if (name === AGENT_NAME && agent_player != null) {
                ...
                controlled_player.rotateTo(look[0], look[1]);
    ...
    playerPostionSafetyCheck(player) {
        ...
        if (((pos_xyz[0] / blockScale) >= (3 * SL / 4)) ||
            ((pos_xyz[0] / blockScale) < (SL / 4)) ||
            ((pos_xyz[1] / blockScale) >= (SL / 2)) ||
            ((pos_xyz[1] / blockScale) < 0) ||
            ((pos_xyz[2] / blockScale) >= (3 * SL / 4)) ||
            ((pos_xyz[2] / blockScale) < (SL / 4)) ) {
